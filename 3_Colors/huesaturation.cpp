...
int main()
{
	...
	cv::imwrite("../output/huesaturation_result_1.jpg", channels[1]);

	// display saturation
	// cv::namedWindow("Saturation");
	// cv::imshow("Saturation",channels[1]);
	cv::imwrite("../output/huesaturation_result_2.jpg", channels[1]);

	// display hue
	// cv::namedWindow("Hue");
	// cv::imshow("Hue",channels[0]);
	cv::imwrite("../output/huesaturation_result_3.jpg", channels[0]);
	...
	cv::imwrite("../output/huesaturation_result_4.jpg", newImage);
	...
	cv::imwrite("../output/huesaturation_result_5.jpg", newImage);
	...
	cv::imwrite("../output/huesaturation_result_6.jpg", newImage);
	...
	cv::imwrite("../output/huesaturation_result_7.jpg", newImage);
	...
	cv::imwrite("../output/huesaturation_result_8.jpg", detected);
	...
	cv::imwrite("../output/huesaturation_result_9.jpg", combined);
