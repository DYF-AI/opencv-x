...
int main()
{
	...
	cv::imwrite("../outputs/finder_Image_1.jpg", image);
	...
	cv::imwrite("../outputs/finder_Saturation_mask.jpg", v[1]);
	...
	cv::imwrite("../outputs/finder_Image_2.jpg", image);
	...
	cv::imwrite("../outputs/finder_Backprojection_on_second_image.jpg", result);
	...
	cv::imwrite("../outputs/finder_Image_2_result.jpg", image);
