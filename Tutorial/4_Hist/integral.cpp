...
int main()
{
	...
	cv::imwrite("../outputs/integral_Original_Image.jpg", image);
	...
	cv::imwrite("../outputs/integral_Fixed_Threshold.jpg", binaryFixed);


	// cv::namedWindow("Adaptive Threshold");
	// cv::imshow("Adaptive Threshold", binaryAdaptive);
	cv::imwrite("../outputs/integral_Adaptive_Threshold.jpg", binaryAdaptive);
	...
	cv::imwrite("../outputs/integral_Adaptive_Threshold_(integral).jpg", binary);
	...
	cv::imwrite("../outputs/integral_Adaptive_Threshold_(filtered).jpg", binaryFiltered);
