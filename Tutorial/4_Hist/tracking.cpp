...
int main()
{
	...
	cv::imwrite("../outputs/tracking_Reference_Histogram.jpg", h.getHistogramImage(roi, 16));
	...
	cv::imwrite("../outputs/tracking_Reference_Histogram (2).jpg", im);
	...
	cv::imwrite("../outputs/tracking_Current_Histogram.jpg", im2);
	...
	cv::imwrite("../outputs/tracking_Initial_Image.jpg", image);

	// cv::namedWindow("New Image");
	// cv::imshow("New Image", secondImage);
	cv::imwrite("../outputs/tracking_New_Image.jpg", secondImage);
	...
	cv::imwrite("../outputs/tracking_Object_location.jpg", secondImage);
